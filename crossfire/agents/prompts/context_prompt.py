...
if TYPE_CHECKING:
    ...
    from crossfire.core.baseline import Baseline
...
async def check_intent_changed(
    ...
    """
    from crossfire.agents.fast_model import FastModelUnavailable
...
async def build_context_system_prompt(
    ...
    """
    from crossfire.agents.fast_model import FastModelUnavailable
    from crossfire.agents.prompts.review_prompt import REVIEW_SYSTEM_PROMPT
