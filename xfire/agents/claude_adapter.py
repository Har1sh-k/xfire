...
from xfire.agents.tools import CLAUDE_TOOLS, MAX_TOOL_ITERATIONS, execute_tool
from xfire.auth import get_claude_setup_token
            ...
            if setup_token:
                ...
                raise AgentError(
                    ...
                    (
                        ...
                        f"  2. Run `xfire auth login --provider claude` to store a setup-token.\n"
